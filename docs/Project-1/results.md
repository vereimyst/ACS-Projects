...
![lstopo graphical output]({{url}}/assets/images/proj-1/cpu.png)
...
![task manager cache values]({{url}}/assets/images/proj-1/task-manager-cache-breakdown.png)
...
![task manager memory bandwidth]({{url}}/assets/images/proj-1/task-manager-memory-breakdown.png)
...
![dell specs]({{url}}/assets/images/proj-1/dell-specs.png)
...
![memory speed graph]({{url}}/assets/images/proj-1/memory-speed.png)
![memory speed graph (scaled)]({{url}}/assets/images/proj-1/memory-speed-scaled.png)
...
![memory throughput read only]({{url}}/assets/images/proj-1/throughput-r.png)
![memory throughput write only]({{url}}/assets/images/proj-1/throughput-w.png)
![memory throughput combined]({{url}}/assets/images/proj-1/throughput-rw.png)
...
![tlb misses]({{url}}/assets/images/proj-1/tlb-misses.png)
